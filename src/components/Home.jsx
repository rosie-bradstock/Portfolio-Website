  ...
  return (
    <div name = "home" className="w-full h-screen bg-gradient-to-r from-indigo-950 to-blue-950">
      <div className="max-w-[1000px] mx-[100px] px-4 flex flex-col justify-center h-full">
        ...
        <p className="text-indigo-100 py-4 max-w-[700px]">I'm a 17 year old student currently completing my A-levels. This website is intended to showcase my coding projects, and to allow me to gain some experience with web development and design.</p>
        <div>
